...
public class CartController {
    ...
    public ResponseEntity<Map<String, Object>> updateCart(
        ...
        if (itemsObj instanceof List<?>) {
            ...
            List<Object> rawList = (List<Object>) itemsObj;
    ...
    @Transactional
    @PostMapping(value = "/cart/add", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
