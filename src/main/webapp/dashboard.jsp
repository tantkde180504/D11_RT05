                                                ...
                                                <div class="stat-card-body">
                                                    ...
                                                    <div class="mt-2">
                                                        <small class="text-success">
                                                            <i class="fas fa-arrow-up me-1"></i>+12.5% so với tháng
                                                            trước
                                                        </small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="stat-card-body">
                                                    ...
                                                    <div class="mt-2">
                                                        <small class="text-info">
                                                            <i class="fas fa-arrow-up me-1"></i>+15.2% so với tháng
                                                            trước
                                                        </small>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="stat-card-body">
                                                    ...
                                                    <div class="mt-2">
                                                        <small class="text-warning">
                                                            <i class="fas fa-exclamation-triangle me-1"></i>5 sản phẩm
                                                            sắp hết hàng
                                                        </small>
                                                    </div>
                                                </div>
                                                    ...
                                                    <table class="table table-hover mb-0">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><span class="badge bg-warning">Đang xử lý</span>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><span class="badge bg-success">Hoàn thành</span>
                                                                </td>
                                                                <td>
                                                                    <button class="btn btn-sm btn-outline-primary me-1">
                                                                        <i class="fas fa-eye"></i>
                                        ...
                                        <div class="col-md-6 mb-4">
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    <form>
                                                        <div class="mb-3">
                                                            <label for="reportType" class="form-label">Loại báo
                                                                cáo</label>
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="dateRange" class="form-label">Khoảng thời
                                                                gian</label>
