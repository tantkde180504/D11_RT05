 ...
 * Generated at: 2025-07-16 13:39:35 UTC
...
public final class product_002ddetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    NumberFormat vndFormat = NumberFormat.getInstance(new Locale("vi", "VN"));
      ...
      out.write("            document.getElementById('buyNowBtn').addEventListener('click', async function() {\r\n");
      out.write("                const quantity = parseInt(document.getElementById('quantityInput').value);\r\n");
      ...
      out.write("                    showToast('Bạn cần đăng nhập để mua hàng!', 'warning');\r\n");
      out.write("                    setTimeout(() => {\r\n");
      out.write("                        window.location.href = contextPath + '/login.jsp?returnUrl=' + encodeURIComponent(window.location.href);\r\n");
      out.write("                    }, 1500);\r\n");
      out.write("                    return;\r\n");
      out.write("                }\r\n");
      out.write("                // Kiểm tra tồn kho\r\n");
      out.write("                const stockElement = document.getElementById('stockStatus');\r\n");
      out.write("                if (stockElement.classList.contains('out-of-stock')) {\r\n");
      out.write("                    showToast('Sản phẩm đã hết hàng!', 'error');\r\n");
      out.write("                    return;\r\n");
      out.write("                }\r\n");
      out.write("                let originalContent = this.innerHTML;\r\n");
      out.write("                try {\r\n");
      out.write("                    // Disable button and show loading\r\n");
      out.write("                    this.innerHTML = '<i class=\"fas fa-spinner fa-spin me-2\"></i>Đang xử lý...';\r\n");
      out.write("                    this.disabled = true;\r\n");
      out.write("                    // Lấy thông tin sản phẩm hiện tại\r\n");
      out.write("                    const productResponse = await fetch(contextPath + '/api/products/' + productId);\r\n");
      out.write("                    const productData = await productResponse.json();\r\n");
      out.write("                    if (!productData.success || !productData.data) {\r\n");
      out.write("                        showToast('Không thể lấy thông tin sản phẩm!', 'error');\r\n");
      out.write("                        return;\r\n");
      out.write("                    }\r\n");
      out.write("                    const product = productData.data;\r\n");
      out.write("                    // --- Lưu vào localStorage cho chế độ mua ngay ---\r\n");
      out.write("                    const buyNowItem = {\r\n");
      out.write("                        id: product.id,\r\n");
      out.write("                        productId: product.id,\r\n");
      out.write("                        name: product.name,\r\n");
      out.write("                        productName: product.name,\r\n");
      out.write("                        price: parseFloat(product.price),\r\n");
      out.write("                        quantity: quantity,\r\n");
      out.write("                        imageUrl: product.imageUrl || contextPath + '/img/RGStrikeGundam.jpg'\r\n");
      out.write("                    };\r\n");
      out.write("                    localStorage.setItem('buyNowItem', JSON.stringify(buyNowItem));\r\n");
      out.write("                    localStorage.setItem('buyNowMode', 'true');\r\n");
      out.write("                    // Chuyển đến trang thanh toán\r\n");
      out.write("                    window.location.href = contextPath + '/payment.jsp?mode=buynow';\r\n");
      out.write("                } catch (error) {\r\n");
      out.write("                    console.error('Error during buy now:', error);\r\n");
      out.write("                    showToast('Có lỗi xảy ra. Vui lòng thử lại!', 'error');\r\n");
      out.write("                } finally {\r\n");
      out.write("                    // Restore button state\r\n");
      out.write("                    this.innerHTML = originalContent;\r\n");
