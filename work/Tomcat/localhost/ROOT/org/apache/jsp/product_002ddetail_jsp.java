 ...
 * Generated at: 2025-07-08 13:44:52 UTC
...
public final class product_002ddetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    NumberFormat vndFormat = NumberFormat.getInstance(new Locale("vi", "VN"));
      ...
      out.write("                const productId = getProductIdFromUrl();\r\n");
      ...
      out.print( session.getAttribute("isLoggedIn") != null ? session.getAttribute("isLoggedIn") : "false" );
      out.write("' === 'true';\r\n");
      out.write("                if (!isLoggedIn) {\r\n");
      out.write("                    alert('Vui lòng đăng nhập để thêm sản phẩm vào danh sách yêu thích!');\r\n");
      ...
      out.write("                const originalClass = icon.className;\r\n");
      out.write("                icon.className = 'fas fa-spinner fa-spin';\r\n");
      out.write("                button.disabled = true;\r\n");
      out.write("                \r\n");
      out.write("                // Call API to toggle favorite\r\n");
      out.write("                fetch(`");
      out.print(request.getContextPath());
      out.write("/api/favorites/toggle/");
      ...
      out.write("                        throw new Error('Vui lòng đăng nhập để thêm sản phẩm yêu thích');\r\n");
      out.write("                    }\r\n");
      out.write("                    if (!response.ok) {\r\n");
      out.write("                        throw new Error('Có lỗi xảy ra khi thêm/xóa sản phẩm yêu thích');\r\n");
      out.write("                    }\r\n");
      out.write("                    return response.json();\r\n");
      out.write("                })\r\n");
      out.write("                .then(data => {\r\n");
      out.write("                    if (data.success) {\r\n");
      out.write("                        if (data.isFavorite) {\r\n");
      out.write("                            // Added to favorites\r\n");
      out.write("                            icon.className = 'fas fa-heart';\r\n");
      out.write("                            button.style.color = '#e74c3c';\r\n");
      out.write("                            button.title = 'Xóa khỏi yêu thích';\r\n");
      out.write("                        } else {\r\n");
      out.write("                            // Removed from favorites\r\n");
      out.write("                            icon.className = 'far fa-heart';\r\n");
      out.write("                            button.style.color = '';\r\n");
      out.write("                            button.title = 'Thêm vào yêu thích';\r\n");
      out.write("                        }\r\n");
      out.write("                        showToast(data.message, 'success');\r\n");
      out.write("                    } else {\r\n");
      out.write("                        throw new Error(data.message || 'Có lỗi xảy ra');\r\n");
      out.write("                    }\r\n");
      out.write("                })\r\n");
      out.write("                .catch(error => {\r\n");
      out.write("                    console.error('Error toggling favorite:', error);\r\n");
      out.write("                    showToast(error.message, 'error');\r\n");
      out.write("                    icon.className = originalClass;\r\n");
      out.write("                })\r\n");
      out.write("                .finally(() => {\r\n");
      ...
      out.write("            });\r\n");
      out.write("            \r\n");
      out.write("            // Initialize wishlist button state\r\n");
      out.write("            const productId = getProductIdFromUrl();\r\n");
      out.write("            const isLoggedIn = '");
      out.print( session.getAttribute("isLoggedIn") != null ? session.getAttribute("isLoggedIn") : "false" );
      out.write("' === 'true';\r\n");
      out.write("            \r\n");
      out.write("            if (isLoggedIn && productId) {\r\n");
      out.write("                // Check if product is already in favorites\r\n");
      out.write("                fetch(`");
      out.print(request.getContextPath());
      out.write("/api/favorites/check/");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${productId}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("`)\r\n");
      out.write("                .then(response => {\r\n");
      out.write("                    if (response.ok) {\r\n");
      out.write("                        return response.json();\r\n");
      out.write("                    }\r\n");
      out.write("                    return { isFavorite: false };\r\n");
      out.write("                })\r\n");
      out.write("                .then(data => {\r\n");
      ...
      out.write("                        wishlistBtn.title = 'Xóa khỏi yêu thích';\r\n");
      out.write("                    } else {\r\n");
      out.write("                        icon.className = 'far fa-heart';\r\n");
      out.write("                        wishlistBtn.style.color = '';\r\n");
      out.write("                        wishlistBtn.title = 'Thêm vào yêu thích';\r\n");
      out.write("                    }\r\n");
      out.write("                })\r\n");
      out.write("                .catch(error => {\r\n");
      out.write("                    console.error('Error checking favorite status:', error);\r\n");
      out.write("                });\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            // Helper function to get product ID from URL\r\n");
      out.write("            function getProductIdFromUrl() {\r\n");
      out.write("                const urlParams = new URLSearchParams(window.location.search);\r\n");
      out.write("                return urlParams.get('id');\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("        \r\n");
