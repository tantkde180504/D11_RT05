 ...
 * Generated at: 2025-07-16 11:00:10 UTC
...
public final class order_002dhistory_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        </div>\r\n");
      out.write("                        <div class=\"mb-3\">\r\n");
      out.write("                            <label for=\"complaintMedia\" class=\"form-label\">Ảnh/Video kèm theo (tùy chọn)</label>\r\n");
      out.write("                            <input class=\"form-control\" type=\"file\" id=\"complaintMedia\" name=\"mediaFiles\"\r\n");
      out.write("                                accept=\"image/*,video/*\" multiple>\r\n");
      out.write("                            <div class=\"form-text\">Chỉ hỗ trợ ảnh (jpg, png) và video (mp4). Có thể chọn nhiều file.\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </div>\r\n");
      out.write("                    </div>\r\n");
      ...
      out.write("                try {\r\n");
      out.write("                    console.log(\"===> Bắt đầu gọi API /api/complaints/my\");\r\n");
      ...
      out.write("                    });\r\n");
      out.write("\r\n");
      out.write("                    console.log(\"===> Response status:\", resp.status);\r\n");
      out.write("                    console.log(\"===> Response ok:\", resp.ok);\r\n");
      out.write("\r\n");
      out.write("                    //const data = await resp.json();\r\n");
      ...
      out.write("                        console.log(\"===> Parsed data:\", data);\r\n");
      out.write("                        console.log(\"===> Is array:\", Array.isArray(data));\r\n");
      out.write("                    } catch (parseError) {\r\n");
      out.write("                        console.error(\"===> Lỗi JSON.parse:\", parseError);\r\n");
      out.write("                        section.innerHTML = '<div class=\"text-danger\">Phản hồi không hợp lệ! Raw response: ' + text + '</div>';\r\n");
      out.write("                        return;\r\n");
      out.write("                    }\r\n");
      out.write("\r\n");
      out.write("                    if (!Array.isArray(data)) {\r\n");
      out.write("                        console.error(\"===> Data is not array:\", data);\r\n");
      ...
      out.write("                    }\r\n");
      out.write("\r\n");
      out.write("                    console.log(\"===> Found\", data.length, \"complaints\");\r\n");
      ...
      out.write("                        '<tr><th>Sản phẩm</th><th>Mã đơn</th><th>Danh mục</th><th>Nội dung</th><th>Trạng thái</th><th>Phản hồi</th><th>Thời gian</th></tr></thead><tbody>';\r\n");
      out.write("\r\n");
      out.write("                    data.forEach(c => {\r\n");
      out.write("                        console.log(\"📦 Complaint object:\", c);\r\n");
      out.write("\r\n");
      out.write("                        // Xử lý an toàn cho các field\r\n");
      out.write("                        const productImage = c.productImage || 'img/logo.png';\r\n");
      out.write("                        const productName = c.productName || 'N/A';\r\n");
      out.write("                        const totalItems = c.totalItems || '1';\r\n");
      out.write("                        const orderNumber = c.orderNumber || '-';\r\n");
      out.write("                        const category = c.category || '-';\r\n");
      out.write("                        const content = c.content || '-';\r\n");
      out.write("                        const status = c.status || 'UNKNOWN';\r\n");
      out.write("                        const staffResponse = c.staffResponse || '-';\r\n");
      out.write("                        const createdAt = c.createdAt || '-';\r\n");
      out.write("\r\n");
      out.write("                        html += '<tr>' +\r\n");
      out.write("                            '<td><div class=\"d-flex align-items-center\"><img src=\"' + productImage + '\" alt=\"' + productName + '\" style=\"width: 50px; height: 50px; object-fit: cover; margin-right: 10px;\"><div class=\"text-start\"><strong>' + productName + '</strong><br><small class=\"text-muted\">SL: ' + totalItems + '</small></div></div></td>' +\r\n");
      out.write("                            '<td>' + orderNumber + '</td>' +\r\n");
      out.write("                            '<td>' + category + '</td>' +\r\n");
      out.write("                            '<td class=\"text-start\">' + content + '</td>' +\r\n");
      out.write("                            '<td><span class=\"badge bg-' + renderStatusColor(status) + '\">' + status + '</span></td>' +\r\n");
      out.write("                            '<td class=\"text-start\">' + staffResponse + '</td>' +\r\n");
      ...
      out.write("                    console.log(\"===> Đã hiển thị thành công!\");\r\n");
      out.write("                } catch (err) {\r\n");
      out.write("                    console.error(\"===> Lỗi tải khiếu nại:\", err);\r\n");
      out.write("                    section.innerHTML = '<div class=\"text-danger\">Lỗi tải khiếu nại: ' + err.message + '</div>';\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            function renderStatusColor(status) {\r\n");
      out.write("                switch (status) {\r\n");
      out.write("                    case 'PENDING': return 'warning';\r\n");
      out.write("                    case 'PROCESSING': return 'info';\r\n");
      out.write("                    case 'COMPLETED': return 'success';\r\n");
      out.write("                    case 'REJECTED': return 'danger';\r\n");
      out.write("                    default: return 'secondary';\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
      out.write("        </script>\r\n");
