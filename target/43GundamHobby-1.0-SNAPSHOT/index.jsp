                        ...
                        <div class="col-lg-2 col-md-3">
                            <div class="logo">
                                <a href="<%=request.getContextPath()%>/">
                                    <img src="<%=request.getContextPath()%>/img/logo.png" alt="43 Gundam Logo"
                                        class="logo-img">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="header-actions d-flex justify-content-end align-items-center">
                                <div class="account-menu me-3">
                                    <div class="dropdown">
                                        <a href="#" class="btn btn-outline-primary dropdown-toggle" id="accountDropdown"
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="<%=request.getContextPath()%>/order.jsp">
                                                    <i class="fas fa-box-open me-2"></i>Đơn hàng
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                                            ...
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        ...
                                                        <li><a class="dropdown-item" href="#">Perfect Grade (PG)</a>
                                                        </li>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <h6 class="dropdown-header">Special Series</h6>
                                                        <li><a class="dropdown-item" href="#">Metal Build</a></li>
                                                        <li><a class="dropdown-item" href="#">Super Deformed (SD)</a>
                                                        </li>
                            ...
                            <div id="heroCarousel" class="carousel slide hero-carousel" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="<%=request.getContextPath()%>/img/Banner1.jpg" class="d-block w-100"
                                            alt="Banner 1"
                                    ...
                                    <div class="carousel-item">
                                        <img src="<%=request.getContextPath()%>/img/Banner2.jpg" class="d-block w-100"
                                            alt="Banner 2"
                                    ...
                                    <div class="carousel-item">
                                        <img src="<%=request.getContextPath()%>/img/Banner3.jpg" class="d-block w-100"
                                            alt="Banner 3"
                                        ...
                                        <div class="carousel-caption">
                                            ...
                                            <p class="banner-subtitle">Giảm giá lên đến 50% cho các sản phẩm chọn lọc
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-3">
                            <div class="side-banners">
                                <div class="side-banner mb-3">
                                    <img src="https://via.placeholder.com/300x200/ff6600/ffffff?text=Sale+50%"
                                        class="img-fluid rounded" alt="Sale Banner">
                                </div>
                                <div class="side-banner">
                                    <img src="https://via.placeholder.com/300x200/006600/ffffff?text=New+Arrivals"
                                        class="img-fluid rounded" alt="New Arrivals">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="category-slider">
                                <div class="category-item">
                                    <a href="#" class="category-link">
                                        <div class="category-icon">
                                            <img src="https://via.placeholder.com/80x80/cccccc/666666?text=HG"
                                                alt="High Grade">
                                        </div>
                                ...
                                <div class="category-item">
                                    <a href="#" class="category-link">
                                        <div class="category-icon">
                                            <img src="https://via.placeholder.com/80x80/cccccc/666666?text=RG"
                                                alt="Real Grade">
                                        </div>
                                ...
                                <div class="category-item">
                                    <a href="#" class="category-link">
                                        <div class="category-icon">
                                            <img src="https://via.placeholder.com/80x80/cccccc/666666?text=MG"
                                                alt="Master Grade">
                                        </div>
                                ...
                                <div class="category-item">
                                    <a href="#" class="category-link">
                                        <div class="category-icon">
                                            <img src="https://via.placeholder.com/80x80/cccccc/666666?text=PG"
                                                alt="Perfect Grade">
                                        </div>
                                ...
                                <div class="category-item">
                                    <a href="#" class="category-link">
                                        <div class="category-icon">
                                            <img src="https://via.placeholder.com/80x80/cccccc/666666?text=MB"
                                                alt="Metal Build">
                                        </div>
                                ...
                                <div class="category-item">
                                    <a href="#" class="category-link">
                                        <div class="category-icon">
                                            <img src="https://via.placeholder.com/80x80/cccccc/666666?text=SD"
                                                alt="Super Deformed">
                                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="https://via.placeholder.com/250x250/cccccc/666666?text=RG+RX-78"
                                        class="img-fluid" alt="RG RX-78-2">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="https://via.placeholder.com/250x250/cccccc/666666?text=MG+Wing"
                                        class="img-fluid" alt="MG Wing Zero">
                                    <div class="product-badges">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="https://via.placeholder.com/250x250/cccccc/666666?text=HG+Strike"
                                        class="img-fluid" alt="HG Strike Freedom">
                                    <div class="product-overlay">
                                        <button class="btn btn-outline-light btn-sm">
                                            <i class="fas fa-eye"></i> Xem nhanh
                                        </button>
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="https://via.placeholder.com/250x250/cccccc/666666?text=PG+Unicorn"
                                        class="img-fluid" alt="PG Unicorn">
                                    <div class="product-badges">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="https://via.placeholder.com/250x250/cccccc/666666?text=RG+Barbatos"
                                        class="img-fluid" alt="RG Barbatos">
                                    <div class="product-badges">
                                        <span class="badge bg-success">Mới</span>
                                    </div>
                                    <div class="product-overlay">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="https://via.placeholder.com/250x250/cccccc/666666?text=MG+Destiny"
                                        class="img-fluid" alt="MG Destiny">
                                    <div class="product-overlay">
                                        <button class="btn btn-outline-light btn-sm">
                                            <i class="fas fa-eye"></i> Xem nhanh
                                        </button>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="https://via.placeholder.com/250x250/cccccc/666666?text=MG+RX-78"
                                        class="img-fluid" alt="MG RX-78-2 Fat Cat">
                                    <div class="product-badges">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 mb-4">
                            <div class="product-card">
                                <div class="product-image">
                                    <img src="https://via.placeholder.com/250x250/cccccc/666666?text=Paint+Set"
                                        class="img-fluid" alt="Paint Set">
                                    <div class="product-overlay">
                                        <button class="btn btn-outline-light btn-sm">
                                            <i class="fas fa-eye"></i> Xem nhanh
                                        </button>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 mb-4">
                                <div class="footer-section">
                                    ...
                                    <p class="footer-desc">Chuyên cung cấp mô hình Gundam chính hãng với giá tốt nhất.
                                        Uy tín - Chất lượng - Dịch vụ tận tâm.</p>
                                    <div class="store-info">
                                        ...
                                        <div class="info-item">
                                            ...
                                            <a href="mailto:43gundamhobby@gmail.com"
                                                class="text-white">43gundamhobby@gmail.com</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 text-md-end">
                                <div class="payment-methods">
                                    ...
                                    <img src="https://via.placeholder.com/40x25/cccccc/666666?text=MC" alt="Mastercard"
                                        class="payment-icon">
                                    <img src="https://via.placeholder.com/40x25/cccccc/666666?text=COD" alt="COD"
                                        class="payment-icon">
                                </div>
                            </div>
                        </div>
